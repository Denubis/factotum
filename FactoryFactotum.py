...
import inspect
import asyncio
from classes.rcon import RconConnection
...
cli = click.CommandCollection(sources=[daemonClick, settingsClick, authClick, installClick, updateClick, mapClick, rconClick])
